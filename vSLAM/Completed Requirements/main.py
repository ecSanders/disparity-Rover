""" Loom link: https://www.loom.com/share/eee8d4c2231943e8a54d2109c1c16b6f """
...
def main(cam, stereo):
    ...
    while True:
        ...
        # Make sure at least 10 feature matches were found
        ...
        img3 = cv2.drawMatches(left, kp1, right, kp2, matches[:10], None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
